    ...
    <div className="flex flex-col gap-6 p-4 md:p-6">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        {[
          ...
          { label: "Classes Covered", value: new Set(assignments.map((a) => a.class)).size, icon: Users, color: "text-blue-600", bg: "bg-blue-500/10" },
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSave} disabled={!form.class || !form.subject || !form.teacherId}>
